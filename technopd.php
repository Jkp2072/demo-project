...
<body>
    <section id="nav-bar">
        <nav class="navbar navbar-expand-lg ">
            <h2><a class="navbar-brand" href="#"><img src="./py.jpeg"><span>P</span>YTHON <span>D</span>ATABASES </a></h2>
        ...
        <div id="headerSlider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img width="100%" src="./5.jpg" class="d-block img-fluid">
                    <div class="carousel-caption">
                        <h5>WHAT IS PYTHON PROGRAMMING?</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img width="100%" src="./6.jpg" class="d-block img-fluid">
                    <div class="carousel-caption">
                        <h5>HOW IS USE PYTHON IN REAL WORLD?</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img width="100%" src="./3.jpg" class="d-block img-fluid">
                    <div class="carousel-caption">
