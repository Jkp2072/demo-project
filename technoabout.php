    ...
    <body>
        ...
        <div class="team">
            ...
            <div class="row">
                <div class="cols">
                    <div class="card">
                        ...
                        <div class="box">
                            <h3>Jeet Patel</h3>
                            <ul>
                                <li><b>Education</b> : CSE,IIIT-SURAT</li>
                                <li><b>Role</b> : Front-End + Back-end</li>
                ...
                <div class="cols">
                    <div class="card">
                        <img src="./gaurav.jpg" alt="gaurav Pandey" width="100%">
                        <div class="box">
                            <h3>Gaurav pandey</h3>
                            <ul>
                ...
                <div class="cols">
                    <div class="card">
                        <img src="./suraj.jpg" alt="Suraj Singh" width="100%">
                        <div class="box">
                            <h3>Suraj M.Singh</h3>
                            <ul>
                                <li><b>Education</b> : EXTC,PCE</li>
                ...
                <div class="cols">
                    <div class="card">
                        <img src="./harshvardhan.jpg" alt="Harshvardhan Goel" width="100%">
                        <div class="box">
                ...
                <div class="cols">
                    <div class="card">
                        <img src="./yash.jpg" alt="yash Jain" width="100%">
                        <div class="box">
                            <h3>Yash Jain</h3>
                            <ul>
                                <li><b>Education</b> : CSE,LNMIIT(Jaipur)</li>
                                <li><b>Role</b> : Front-End </li>
                ...
                <div class="cols">
                    <div class="card">
                        <img src="./vandit.jpg" alt="Vandit Jain" width="100%">
                        <div class="box">
                            <h3>Vandit Jain</h3>
                            <ul>
                                <li><b>Education</b> : CSE,VIT(Vellore)</li>
                                <li><b>Role</b> : Front-End </li>
                ...
                <div class="cols">
                    <div class="card">
                        <img src="./adarsh.jpg" alt="Adarsh srivastava" width="100%">
                        <div class="box">
                            <h3>Adarsh Srivastava</h3>
                            <ul>
                                <li><b>Education</b> : MCA,IMS(Ghazizbad)</li>
                                <li><b>Role</b> : Front-End </li>
