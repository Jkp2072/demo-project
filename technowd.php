    ...
    <body>
        <section id="nav-bar">
            <nav class="navbar navbar-expand-lg ">
                <h2><a class="navbar-brand" href="technocolabsmainpage.php"><img src="./abcd.jpg"></a>   <span>W</span>EB <SPAN>D</SPAN>EVELOPMENT</h2>
            ...
            <div id="headerSlider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img width="100%" src="./baby.jpg" class="d-block img-fluid" >
                        <div class="carousel-caption">
                            <h5>WHAT IS WEB DEVELOPMENT ?</h5>
                        </div>
                  </div>    
                  <div class="carousel-item">
                    <img width="100%" src="./icons8-settings-100.png" class="d-block img-fluid" >
                        <div class="carousel-caption">
                            <h5>HOW IS WEB DEVELOPING USED?</h5>
                        </div>
                  </div>
                  <div class="carousel-item">
                    <img width="100%" src="./icons8-settings-50.png" class="d-block img-fluid" >
                        <div class="carousel-caption">
